...
public enum Talla {
	...
	T34("34", Arrays.asList("34","6")),
	T35("35", Arrays.asList("35")),
	T36("36", Arrays.asList("36","8")),
	T37("37", Arrays.asList("37")),
	T38("38", Arrays.asList("38","10")),
	T39("39", Arrays.asList("39")),
	T40("40", Arrays.asList("40","12")),
	T41("41", Arrays.asList("41")),
	T42("42", Arrays.asList("42","14")),
	T43("43", Arrays.asList("43")),
	T44("44", Arrays.asList("44","16")),
	T45("45", Arrays.asList("45")),
	T46("46", Arrays.asList("46","18")),
