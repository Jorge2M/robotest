...
public class SecBolsaButtonAndLinksNew extends WebdrvWrapp {
    ...
    public enum LinksAfterBolsa { DetalleProducto, DisponibilidadTienda, EnvioYDevoluciones, Compartir }
    ...
    static String XPathLinkEnvioYDevoluciones = "//button[@id='shipmentAndReturnsOption']";
    ...
    public static String getXPathLink(LinksAfterBolsa linkType) {
        switch (linkType) {
        case EnvioYDevoluciones:
            return XPathLinkEnvioYDevoluciones;
