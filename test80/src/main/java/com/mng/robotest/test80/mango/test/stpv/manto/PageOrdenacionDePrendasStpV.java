...
public class PageOrdenacionDePrendasStpV {
    ...
    public static ListResultValidation validateIsPage(DatosStep datosStep, WebDriver driver) {
        ...
        validations.add(
                ...
                !PageOrdenacionDePrendas.isElementInStateUntil(Orden.verTiendas, StateElem.Visible, maxSecondsWait, driver), State.Warn);
        return validations;
    }
    ...
    public static ListResultValidation validateSectionPrenda(DatosStep datosStep, WebDriver driver) {
        ...
        validations.add(
                ...
                !PageOrdenacionDePrendas.isElementInStateUntil(Orden.verPrendas, StateElem.Visible, maxSecondsWait, driver), State.Warn);
        return validations;
    }
    ...
    public static ListResultValidation validateTipoPrenda(DatosStep datosStep, WebDriver driver, int maxSecondsWait) {
        ...
        validations.add(
                ...
                !PageOrdenacionDePrendas.isElementInStateUntil(Orden.pruebaCamisa, StateElem.Visible, maxSecondsWait, driver), State.Warn);
        return validations;
    }
    ...
    public static ListResultValidation validateBajarPrenda(DatosStep datosStep, WebDriver driver, int maxSecondsWait) {
        ...
        validations.add(
                ...
                !PageOrdenacionDePrendas.isElementInStateUntil(Orden.primeraPrenda, StateElem.Visible, maxSecondsWait, driver), State.Warn);
        return validations;
    }
    ...
    public static ListResultValidation validateAplicarOrden(DatosStep datosStep, WebDriver driver) {
        ...
        validations.add(
                ...
                !PageOrdenacionDePrendas.isElementInStateUntil(Modal.applyCountry, StateElem.Visible, maxSecondsWait, driver), State.Warn);
        validations.add(
                "Aparece correctamente el boton de <b>cancelar</b>",
