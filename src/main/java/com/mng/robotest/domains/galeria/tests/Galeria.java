...
public class Galeria {
	...
	@Test (
		groups={"Galeria", "Canal:mobile,tablet_App:all"}, alwaysRun=true, 
	...
	@Test (
		groups={"Galeria", "Canal:all_App:all"}, alwaysRun=true, 
	...
	@Test (
		groups={"Galeria", "Canal:desktop_App:shop,outlet"}, alwaysRun=true, 
		description=
	...
	@Test (
		groups={"Galeria", "Canal:desktop_App:shop"}, alwaysRun=true,
