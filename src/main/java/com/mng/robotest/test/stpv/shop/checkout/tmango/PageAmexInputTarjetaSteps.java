...
public class PageAmexInputTarjetaSteps {
	...
	public PageRedsysSimStpV inputTarjetaAndPayButton(
		...
		PageRedsysSimStpV pageRedsysSimStpV = new PageRedsysSimStpV(pageAmexInputTarjeta.driver);
		pageRedsysSimStpV.checkPage();
