...
public abstract class PageDetalleCompra extends PageObjTM implements PageDetallePedido {
	...
	public static PageDetalleCompra make(Channel channel, AppEcom app) {
		switch (channel) {
		case desktop:
			return new PageDetalleCompraDesktop(channel);
		case mobile:
		case tablet:
			return new PageDetalleCompraMobil(channel, app);
		}
		return null;
	}
