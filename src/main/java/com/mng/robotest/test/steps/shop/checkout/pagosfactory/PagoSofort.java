...
public class PagoSofort extends PagoSteps {
	...
	public void testPagoFromCheckout(boolean execPay) throws Exception {
		...
		boolean isPageIconoSofort = new PageSofort1rst(channel, driver).isPageVisibleUntil(3);
		...
		if (isPageIconoSofort) {
			PageSofortIconosBancoSteps pageSofortIconosBancoSteps = new PageSofortIconosBancoSteps(channel, driver);
