...
public class TestABactive {
	...
	public static void currentTestABsToActivate(Channel channel, AppEcom app, WebDriver driver) 
		...
		var testABs = Arrays.asList(
			...
			TestABactData.getNew(KIRITAKI_FASE5_REDISENO_AVISAME_SHOP_PRE, 0),
			TestABactData.getNew(KIRITAKI_FASE5_REDISENO_AVISAME_DESKTOP_PRO, 0),
			TestABactData.getNew(KIRITAKI_FASE5_REDISENO_AVISAME_MOBILE_PRO, 0),
			TestABactData.getNew(KIRITAKI_FASE5_REDISENO_AVISAME_DESKTOP_OUTLET_PRO, 0),
			TestABactData.getNew(KIRITAKI_FASE5_REDISENO_AVISAME_MOBILE_OUTLET_PRO, 0),
