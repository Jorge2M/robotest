...
//		listTestABsToActivate.add(TestABactData.getNew(TestABOptimizeImpl.New_Registry_MLY_Desktop_PRO, 0));
		...
		listTestABsToActivate.add(TestABactData.getNew(TestABOptimizeImpl.PDP_Desktop_Size_Selector_Outlet_PRE, 0));
		listTestABsToActivate.add(TestABactData.getNew(TestABOptimizeImpl.PDP_Desktop_Size_Selector_Outlet_PRO, 0));
