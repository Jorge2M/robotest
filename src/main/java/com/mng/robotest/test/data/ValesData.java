...
//			return getValesVIPMNG(campanya, filterCal);
	...
	public static List<ValePais> getMNGVIP2019(Campanya campanya, boolean filterCal) throws Exception {
		...
		addValePais(FactoryVale.makeWithArticles(campanya, PaisShop.COREA_DEL_SUR, 30, "09/06/2019 00:00", "12/06/2019 00:00", filterCal, Arrays.asList("43029089"), Arrays.asList("53070658")), listaPaisesVales);
		addValePais(FactoryVale.makeWithArticles(campanya, PaisShop.COREA_DEL_SUR, 40, "09/06/2019 00:00", "12/06/2019 00:00", filterCal, Arrays.asList("43097700"), Arrays.asList("53070658")), listaPaisesVales);
		...
		addValePais(FactoryVale.makeWithArticles(campanya, PaisShop.ESPANA, 30, "13/06/2019 00:00", "19/06/2019 00:00", filterCal, Arrays.asList("67090613"), Arrays.asList("67074407")), listaPaisesVales);
		addValePais(FactoryVale.makeWithArticles(campanya, PaisShop.ISLAS_CANARIAS, 30, "13/06/2019 00:00", "19/06/2019 00:00", filterCal, Arrays.asList("43097700"), Arrays.asList("53070658")), listaPaisesVales);
		...
		addValePais(FactoryVale.makeWithArticles(campanya, PaisShop.UNITED_KINGDOM, 30, "08/06/2019 00:00", "14/06/2019 00:00", filterCal, Arrays.asList("43097700"), Arrays.asList("53070658")), listaPaisesVales);
	...
	public static List<ValePais> getIMVIP2019(Campanya campanya, boolean filterCal) throws Exception {
		...
		addValePais(FactoryVale.makeWithArticles(campanya, PaisShop.ESPANA, 30, "13/06/2019 00:00", "19/06/2019 00:00", filterCal, Arrays.asList("43029089"), Arrays.asList("53070658")), listaPaisesVales);
		addValePais(FactoryVale.makeWithArticles(campanya, PaisShop.ISLAS_CANARIAS, 30, "13/06/2019 00:00", "19/06/2019 00:00", filterCal, Arrays.asList("43029089"), Arrays.asList("53070658")), listaPaisesVales);
	...
	public static List<ValePais> getVIP19(Campanya campanya, boolean filterCal) throws Exception {
		...
		addValePais(FactoryVale.makeWithArticles(campanya, PaisShop.MEXICO, 30, "06/06/2019 00:00", "09/06/2019 00:00", filterCal, Arrays.asList("43023720"), Arrays.asList("53070658")), listaPaisesVales);
		...
		addValePais(FactoryVale.makeWithArticles(campanya, PaisShop.ESPANA, 30, "15/06/2019 00:00", "19/06/2019 00:00", filterCal, Arrays.asList("43029089"), Arrays.asList("53070658")), listaPaisesVales);
		...
		addValePais(FactoryVale.makeWithArticles(campanya, PaisShop.UNITED_KINGDOM, 30, "11/06/2019 00:00", "14/06/2019 00:00", filterCal, Arrays.asList("43029089"), Arrays.asList("53070658")), listaPaisesVales);
		addValePais(FactoryVale.makeWithArticles(campanya, PaisShop.CZECH_REPUBLIC, 30, "09/06/2019 00:00", "12/06/2019 00:00", filterCal, Arrays.asList("43029089"), Arrays.asList("53070658")), listaPaisesVales);
