...
public class BannerCabeceraObject extends BannerObject {
	...
	private static final String XP_WRAPPER_BANNER = "//div[@class='vsv-binteriorwrap' or @class='vsv-bannercontainer']//div[@class='vsv-box' and @data-id]";
	private static final String XP_BANNER = XP_WRAPPER_BANNER + "//div[@class[contains(.,'vsv-content-web')]]";
	private static final String XP_ANCOR_RELATIVE_BANNER = "../a[@href]";
