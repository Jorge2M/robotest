...
public class PageRegalarMisLikesSteps extends StepBase {
	...
	private final PageRegalarMisLikes pgRegalarMisLikes = new PageRegalarMisLikes();

	@Validation (description="Estamos en la página de \"Regalar Likes\"")
	public boolean checkIsPage() {
		return (pgRegalarMisLikes.checkIsPage());
	}
	...
	public void inputReceptorAndClickContinuar(String mensaje, String emailReceptor) {
		pgRegalarMisLikes.inputMensaje(mensaje);
		pgRegalarMisLikes.inputEmailReceptor(emailReceptor);
		pgRegalarMisLikes.clickContinuar();
	...
	public boolean checkCuantosLikesVisible() {
		return (pgRegalarMisLikes.checkIsVisibleBlockCuantosLikes());
	}
	...
	public PageResultadoRegaloLikesSteps inputNumLikesAndClickEnviarRegalo(int numLikesToRegalar) {
		pgRegalarMisLikes.inputLikesToRegalar(numLikesToRegalar);
		pgRegalarMisLikes.clickEnviarRegalo();
