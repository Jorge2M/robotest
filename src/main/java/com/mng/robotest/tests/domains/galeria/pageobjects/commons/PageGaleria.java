...
import com.mng.robotest.tests.domains.galeria.pageobjects.nogenesis.PageGaleriaDeviceNormal;
...
import static com.mng.robotest.tests.domains.galeria.pageobjects.commons.PageGaleria.AttributeArticle.*;
...
public abstract class PageGaleria extends PageBase {
	...
	protected abstract String getXPathArticleHearthIcon(int posArticulo);
	public abstract StateFavorito getStateHearthIcon(int iconNumber);
